const translations = {
    ru: {
        ...
        category_bots: '🤖 Боты',
        category_games: '🎯 Игры',
        category_extensions: '🧩 Расширения для браузера',
        youtube_speed_customizer: '⏳ Управление скоростью YouTube',
        convert_to_usd: '💵 Конвертер цен в USD (kolesa.kz / kolesa.kg)',
    ...
    en: {
        ...
        youtube_speed_customizer: '⏳ YouTube Speed Customizer',
        convert_to_usd: '💵 Convert price to USD (kolesa.kz / kolesa.kg)',
        category_api: '📡 API Swagger',
        shop: '🛍️ Dich Shop',
